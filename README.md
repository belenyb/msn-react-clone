# MSN Windows Live Messenger Clone with Gemini 2.5 Flash
## Project Overview
...
```
Update the REACT_APP_API_KEY in your .env file to use the [Gemini 2.5 Flash API](https://aistudio.google.com/app/apikey):
```console
...
- @google/generative-ai: For interacting with Gemini 2.5 Flash.
